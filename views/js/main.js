...
var resizePizzas = function(size) {
  ...
  // Chooses corresponding width percentage for each size
  ...
  // Iterates through pizza elements on the page and changes their width percentages
  var randomPizzaWidth = document.querySelectorAll(".randomPizzaContainer");
  var newSize = sizeSwitcher(size);
  function changePizzaSizes(size) {
    for (var i = 0; i < randomPizzaWidth.length; i++) {
      randomPizzaWidth[i].style.width = newSize + '%';
    }
  }
